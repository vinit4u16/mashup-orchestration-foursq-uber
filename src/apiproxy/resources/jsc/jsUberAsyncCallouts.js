...
<<<<<<< HEAD
     ...
     //      fourSquareObject.specials = fourSqResponse.response.groups[0].items[i].venue.specials.items[0].message;
	    // }
		if(fourSqResponse.response.groups[0].items[i].snippets.items[0].detail.object.message)
 		{
          fourSquareObject.specials = fourSqResponse.response.groups[0].items[i].snippets.items[0].detail.object.message;
=======
	    if(fourSqResponse.response.groups[0].items[i].venue.specials.items[0].message)
	    {
          fourSquareObject.SpecialMessage = fourSqResponse.response.groups[0].items[i].venue.specials.items[0].message;
>>>>>>> 9bf5effaa5a7b4762ee47b10fc1f9f2aeff3e6f4
	    }
